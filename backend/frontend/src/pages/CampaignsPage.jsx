...
const CampaignsPage = () => {
    ...
    const fetchPortfolio = async () => {
        ...
        try {
            const response = await fetch(`http://localhost:8080/api/investments/portfolio/${user.userId}`, {
                headers: { 'Authorization': `Bearer ${token}` }
            });
        ...
        try {
            ...
            const options = {
                ...
                handler: async function (response) {
                    ...
                    const dbResponse = await fetch("http://localhost:8080/api/investments/invest", {
                        method: "POST",
                        headers: {
